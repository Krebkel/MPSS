...
CREATE TABLE mpss."Users" (
                              "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                              "EmployeeId" integer NOT NULL,
                              "Password" text NOT NULL,
                              "Role" text NOT NULL,
                              CONSTRAINT "PK_Users" PRIMARY KEY ("Id"),
                              CONSTRAINT "FK_Users_Employees_EmployeeId" FOREIGN KEY ("EmployeeId") REFERENCES mpss."Employees" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE mpss."ProjectFile" (
                                    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                                    "Name" text NOT NULL,
                                    "FilePath" text NOT NULL,
                                    "ProjectId" integer,
                                    "UploadDate" timestamp with time zone NOT NULL,
                                    CONSTRAINT "PK_ProjectFile" PRIMARY KEY ("Id"),
                                    CONSTRAINT "FK_ProjectFile_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES mpss."Projects" ("Id")
);
...
CREATE INDEX "IX_ProjectFile_ProjectId" ON mpss."ProjectFile" ("ProjectId");
...
CREATE INDEX "IX_Users_EmployeeId" ON mpss."Users" ("EmployeeId");

INSERT INTO mpss."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20240908121459_Initial', '8.0.7');
